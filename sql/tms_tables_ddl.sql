...
CREATE TABLE tms_courseware (
  ...
  CONSTRAINT fk_courseware_machine_type FOREIGN KEY (machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_courseware_major FOREIGN KEY (major_id) REFERENCES tms_major (major_id),
  CONSTRAINT fk_courseware_training_type FOREIGN KEY (training_type_id) REFERENCES tms_training_type (training_type_id)
...
CREATE TABLE tms_courseware_file (
  ...
  CONSTRAINT fk_courseware_file_courseware FOREIGN KEY (courseware_id) REFERENCES tms_courseware (courseware_id)
...
CREATE TABLE tms_student (
  ...
  CONSTRAINT fk_student_machine_type FOREIGN KEY (primary_machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_student_major FOREIGN KEY (primary_major_id) REFERENCES tms_major (major_id)
...
CREATE TABLE tms_instructor_ability (
  ...
  CONSTRAINT fk_instructor_ability_instructor FOREIGN KEY (instructor_id) REFERENCES tms_instructor (instructor_id),
  CONSTRAINT fk_instructor_ability_machine_type FOREIGN KEY (machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_instructor_ability_major FOREIGN KEY (major_id) REFERENCES tms_major (major_id),
  CONSTRAINT fk_instructor_ability_training_type FOREIGN KEY (training_type_id) REFERENCES tms_training_type (training_type_id),
  CONSTRAINT fk_instructor_ability_courseware FOREIGN KEY (courseware_id) REFERENCES tms_courseware (courseware_id)
...
CREATE TABLE tms_student_ability (
  ...
  CONSTRAINT fk_student_ability_student FOREIGN KEY (student_id) REFERENCES tms_student (student_id),
  CONSTRAINT fk_student_ability_machine_type FOREIGN KEY (machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_student_ability_major FOREIGN KEY (major_id) REFERENCES tms_major (major_id),
  CONSTRAINT fk_student_ability_training_ability FOREIGN KEY (training_ability_id) REFERENCES tms_training_ability (training_ability_id),
  CONSTRAINT fk_student_ability_courseware FOREIGN KEY (courseware_id) REFERENCES tms_courseware (courseware_id)
...
CREATE TABLE tms_training_plan (
  ...
  CONSTRAINT fk_training_plan_machine_type FOREIGN KEY (machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_training_plan_major FOREIGN KEY (major_id) REFERENCES tms_major (major_id),
  CONSTRAINT fk_training_plan_training_ability FOREIGN KEY (training_ability_id) REFERENCES tms_training_ability (training_ability_id)
...
CREATE TABLE tms_training_plan_detail (
  ...
  CONSTRAINT fk_training_plan_detail_plan FOREIGN KEY (training_plan_id) REFERENCES tms_training_plan (training_plan_id),
  CONSTRAINT fk_training_plan_detail_courseware FOREIGN KEY (courseware_id) REFERENCES tms_courseware (courseware_id)
...
CREATE TABLE tms_training_class (
  ...
  CONSTRAINT fk_training_class_plan FOREIGN KEY (training_plan_id) REFERENCES tms_training_plan (training_plan_id),
  CONSTRAINT fk_training_class_machine_type FOREIGN KEY (machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_training_class_major FOREIGN KEY (major_id) REFERENCES tms_major (major_id),
  CONSTRAINT fk_training_class_training_ability FOREIGN KEY (training_ability_id) REFERENCES tms_training_ability (training_ability_id),
  CONSTRAINT fk_training_class_instructor FOREIGN KEY (primary_instructor_id) REFERENCES tms_instructor (instructor_id)
...
CREATE TABLE tms_class_student (
  ...
  CONSTRAINT fk_class_student_class FOREIGN KEY (training_class_id) REFERENCES tms_training_class (training_class_id),
  CONSTRAINT fk_class_student_student FOREIGN KEY (student_id) REFERENCES tms_student (student_id)
...
CREATE TABLE tms_training_record (
  ...
  CONSTRAINT fk_training_record_student FOREIGN KEY (student_id) REFERENCES tms_student (student_id),
  CONSTRAINT fk_training_record_class FOREIGN KEY (training_class_id) REFERENCES tms_training_class (training_class_id),
  CONSTRAINT fk_training_record_courseware FOREIGN KEY (courseware_id) REFERENCES tms_courseware (courseware_id),
  CONSTRAINT fk_training_record_instructor FOREIGN KEY (instructor_id) REFERENCES tms_instructor (instructor_id)
...
CREATE TABLE tms_certificate (
  ...
  CONSTRAINT fk_certificate_student FOREIGN KEY (student_id) REFERENCES tms_student (student_id),
  CONSTRAINT fk_certificate_class FOREIGN KEY (training_class_id) REFERENCES tms_training_class (training_class_id),
  CONSTRAINT fk_certificate_machine_type FOREIGN KEY (machine_type_id) REFERENCES tms_machine_type (machine_type_id),
  CONSTRAINT fk_certificate_major FOREIGN KEY (major_id) REFERENCES tms_major (major_id),
  CONSTRAINT fk_certificate_training_ability FOREIGN KEY (training_ability_id) REFERENCES tms_training_ability (training_ability_id)
...
-- 显示创建结果
-- ================================
SELECT '=== TMS业务表结构创建完成 ===' AS message;
...
SELECT '1. 运行基础初始化数据脚本' AS step1;
SELECT '2. 验证外键约束和索引' AS step2;
SELECT '3. 导入TMS业务初始化数据' AS step3;
SELECT '4. 测试MyBatis-Plus实体映射' AS step4;
SELECT '5. 验证业务逻辑和数据完整性' AS step5;